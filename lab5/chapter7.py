...
# Use == if you are asking if they are equal, use = if you are assigning a value.
...
# These are also legal and will trigger as being true because the
# values are not zero:
if 1:
    print("1")
if "A":
...
# The first if statement appears to work, but it will always trigger
# as true even if the variable a is not equal to b.
...
# Comparisons using string/text. The input statement will ask the
# user for input and put it in user_name.
